...
import org.example.twainprint.jtwain.variable.TwainArray;
...
public class ScannerFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        docSource.setModel(new DefaultComboBoxModel<>(new String[] { "Auto document feeder", "Flatbed" }));
        ...
        jLabel3.setText("Режим цвета颜色");

        colorMode.setModel(new DefaultComboBoxModel<>(new String[] { "Черно-белый", "Градации серого", "Цветной" }));
        ...
        dpi.setModel(new DefaultComboBoxModel<>(new String[] { "50", "100", "150", "200", "300", "400", "500", "600" }));
        ...
        jScrollPane2.setBorder(BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
